...
*3.11 /SimpleGroupware_0.745/src/core/functions.php
    Add check of ID field type and extract numbers only to eliminate SQL error while click on filename (CIFS dir).

*3.12 /SimpleGroupware_0.745/src/core/functions.php
    Add folder name check to remove error messages on empty name.
